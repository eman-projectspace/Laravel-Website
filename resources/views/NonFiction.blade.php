...
<div class="container mt-5">
    <h1 class="text-center mb-3">Non-Fiction Books</h1>
    <p class="text-center mb-4 text-secondary fs-6">
        Elegant and educational non-fiction books inspired by real-world experiences.
    </p>
    ...
    <div class="row g-3">
        ...
        @empty
            <p class="text-center fs-6 text-muted">No non-fiction books found.</p>
        @endforelse
    </div>
</div>
