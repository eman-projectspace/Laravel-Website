...
<div class="container mt-5">
    <h1 class="text-center">Fiction Books</h1>
    <p class="text-center">Explore our stunning collection of fiction books.</p>
    ...
    <div class="row">
        ...
        @empty
            <p class="text-center">No fiction books found.</p>
        @endforelse
    </div>
</div>
@endsection
