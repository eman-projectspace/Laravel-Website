...
<div class="container mt-5">
    <h1 class="text-center mb-3">Children's Books</h1>
    <p class="text-center mb-4 text-secondary fs-6">
        Explore our colorful collection for young readers.
    </p>
    ...
    <div class="row g-3">
        ...
        @empty
            <p class="text-center fs-6 text-muted">No children's books found.</p>
        @endforelse
    </div>
</div>
